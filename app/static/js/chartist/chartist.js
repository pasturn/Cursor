...
(function(window, document, Chartist) {
  ...
  /**
   * This method creates a foreignObject (see https://developer.mozilla.org/en-US/docs/Web/SVG/Element/foreignObject) that allows to embed HTML cursor into a SVG graphic. With the help of foreignObjects you can enable the usage of regular HTML elements inside of SVG where they are subject for SVG positioning and transformation but the Browser will use the HTML rendering capabilities for the containing DOM.
   *
   * @memberof Chartist.Svg
  ...
  function foreignObject(content, attributes, className, insertFirst) {
    // If cursor is string then we convert it to DOM
    // TODO: Handle case where cursor is not a string nor a DOM Node
    ...
    // Adding namespace to cursor element
    ...
    // Add cursor to foreignObjectElement
